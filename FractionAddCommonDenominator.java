...
public class FractionAddCommonDenominator implements Problem {
    ...
    public Problem execute() {
        ...
        out.print("First enter the numerator: ");
        if(readUser.nextInt() != numerator) {
            ...
            out.print("Now what is the numerator?: ");
            while(readUser.nextInt() != numerator) {
                out.print("That is incorrect. Try again. What is the numerator?: ");
            }
        }
        out.print("Correct. Enter the denominator: ");
        while(readUser.nextInt() != denominator) {
            out.print("Wrong. Enter the denominator: ");
        }
